...
namespace Infrastructure.CrossCutting.IoC.Unity 
{
    ...
    using Infrastructure.Data.BoundedContext.BlobAggregates;
        ...
        :IContainer
    {
        ...
        void ConfigureRootContainer(IUnityContainer container)
        {
            ...
            container.RegisterType<IBlobAggregateRepository, BlobAggregateRepository>(new TransientLifetimeManager());
            ...
            container.RegisterType<IBlobManagementServices, BlobManagementServices>(new TransientLifetimeManager());
