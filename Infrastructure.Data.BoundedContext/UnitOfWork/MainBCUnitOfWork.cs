...
// Type: Infrastructure.Data.BoundedContext.UnitOfWork.MainBCUnitOfWork
// Assembly: Infrastructure.Data.BoundedContext, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// MVID: 2F9484BF-4D2F-45EC-817E-884CB99FB111
// Assembly location: C:\Pedago\Solution1\ASP.NET.MVC5.Client\bin\Infrastructure.Data.BoundedContext.dll
...
using Domain.Core;
using Infrastructure.Data.BoundedContext.Reources;
...
namespace Infrastructure.Data.BoundedContext.UnitOfWork
{
    public class MainBCUnitOfWork : DbContext, IMainBCUnitOfWork 
    {
        ...
        private IDbSet<News> _news;
        private IDbSet<Event> _events;
        #endregion
        ...
        public IDbSet<News> News
        {
            ...
            {
                if (this._news == null)
                    this._news = (IDbSet<News>)this.Set<News>();
                return this._news;
            }
        }
        ...
        public IDbSet<Event> Events
        {
            get
            {
                if (this._events == null)
                    this._events = (IDbSet<Event>)this.Set<Event>();
                return this._events;
            }
        }
