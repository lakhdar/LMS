namespace Infrastructure.Data.BoundedContext.UnitOfWork
{
    ...
    public class FakeBCUnitOfWork : IMainBCUnitOfWork
    {
        #region Field
        ...
        private MemorySet<News> _news;
        private MemorySet<Event> _events;
        ...
        public IDbSet<News> News
        {
            ...
            {
                if (this._news == null)
                    this._news = new MemorySet<News>(this.data.News);
                return (IDbSet<News>)this._news;
            }
        }
        ...
        public IDbSet<Event> Events
        {
            get
            {
                if (this._events == null)
                    this._events = new MemorySet<Event>((IEnumerable<Event>)this.data.Events);
                return (IDbSet<Event>)this._events;
            }
        }
