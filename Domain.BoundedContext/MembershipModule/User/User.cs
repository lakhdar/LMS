...
namespace Domain.BoundedContext.MembershipModule
{
    ...
    public class User : Person
    {
        ...
        /// <summary>
        /// Get or Set Events published by  the user
        /// </summary>
        public virtual ICollection<Event> Events { get; set; }

        /// <summary>
        /// Get or Set News published by  the user
        /// </summary>
        public virtual ICollection<News> News { get; set; }

        /// <summary>
        /// Get or Set Comments published by  the user
        /// </summary>
        public virtual ICollection<Comment> Comments { get; set; }

        /// <summary>
        /// Get or Set Assigned Courses to the User 
        /// </summary>
        public virtual ICollection<CourseAssign> AssignedCourses { get; set; } 
